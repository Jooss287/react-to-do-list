...
export const AlwaysOnTopSvg = ({ size }) => (
  <svg
    className={`w-${size} h-${size} text-gray-800 dark:text-white`}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
